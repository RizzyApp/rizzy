        ...
        <div ref={ref} className={`relative flex bg-gray-200 h-card-big ${swipeCardImageAspectRatioClassName}`}>
            ...
            <div className="absolute bottom-5 left-1 mb-4 pl-4">
                <div>
                    ...
                    <span
                        className="drop-shadow-[0_1.2px_1.2px_rgba(0,0,0,1)] font-poppins text-white pl-4 text-3xl">{cardData.age}</span>
                </div>
                <div className='mt-2'>
                    <img src="./image/locatin-icon-white.png" alt="" width='30px' className='inline'/>
                    <span
                        className="drop-shadow-[0_1.2px_1.2px_rgba(0,0,0,1)] font-poppins text-white text-1xl">{!cardData.distance ? placeholderDistance : cardData.distance} kilometers away</span>
                </div>
            </div>
        </div>
    );
